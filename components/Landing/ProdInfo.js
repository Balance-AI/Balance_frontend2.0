      ...
      left: (
        <>
          ...
          <p className={Prodstyles.prodinfo__p}>
            Business Analytics is an essential process that directly correlates
            to the success of every business. Deriving key insights hidden in
            data can be incredibly time consuming and requires years of
            technical experience. Balance AI eliminates this problem for
            business owners providing industry standard insights through guided
            conversation.
          </p>
          <ul className={Prodstyles.prodinfo__list}>
            ...
            <li className={Prodstyles.prodinfo__listitem}>
              Generate All Possible Graphs & Visualizations Using Proprietary
              Data.
            </li>
            <li className={Prodstyles.prodinfo__listitem}>
              Build Strategy through Highly Intuitive Insight Analysis & Risk
              Management Alerts.
            </li>
          </ul>
    ...
    Analytics: {
      left: (
        <>
          ...
          <p className={Prodstyles.prodinfo__p}>
            Balance AI consolidates all your enterprise’s financial & marketing
            data into simple, concise visualizations. Our platform optimizes to
            highlight the most important KPIs for your specific business and
            industry. No need to sort through multiple softwares to understand
            business performance, all you need is Balance AI.
          </p>
          <ul className={Prodstyles.prodinfo__list}>
            <li className={Prodstyles.prodinfo__listitem}>
            ...
            <li className={Prodstyles.prodinfo__listitem}>
              Expert User Experience Design allowing for unseamed platform
              navigation.
            </li>
          </ul>
          <div className={Prodstyles.prodinfo__frontboard__leftbuttons}>
    ...
    Integrations: {
      left: (
        <>
          ...
          <p className={Prodstyles.prodinfo__p}>
            Empower your analytics with seamless integration of all your
            business data. Connect to every platform your company operates on
            with just one click, supporting all major platforms for businesses
            of every type.
          </p>
          <ul className={Prodstyles.prodinfo__list}>
            <li className={Prodstyles.prodinfo__listitem}>
              Effortlessly integrate with all major platforms your business
              relies on.
            </li>
            <li className={Prodstyles.prodinfo__listitem}>
              Universal compatibility ensures businesses across industries can
              centralize their data and uncover valuable insights.
            </li>
            <li className={Prodstyles.prodinfo__listitem}>
              Easily add or manage new integrations as your business grows.
            </li>
          </ul>
          <div className={Prodstyles.prodinfo__frontboard__leftbuttons}>
            <a
    ...
    Management: {
      left: (
        <>
          ...
          <p className={Prodstyles.prodinfo__p}>
            Effortlessly track all projects, deadlines, and team members' tasks
            with a centralized, user-friendly platform designed for efficient
            collaboration
          </p>
          <ul className={Prodstyles.prodinfo__list}>
            <li className={Prodstyles.prodinfo__listitem}>
              Centralized hub for organizing and managing all project details.
            </li>
            <li className={Prodstyles.prodinfo__listitem}>
              Easily assign tasks, track progress, and ensure accountability
              across teams.
            </li>
            <li className={Prodstyles.prodinfo__listitem}>
              Receive instant updates on milestones, deadlines, and task
              completions.
            </li>
          </ul>
          <div className={Prodstyles.prodinfo__frontboard__leftbuttons}>
    ...
    Governance: {
      left: (
        <>
          ...
          <p className={Prodstyles.prodinfo__p}>
            Ensure robust data security and compliance with a unified governance
            model for managing structured and unstructured data across your
            ecosystem. Unlock actionable insights tailored to your business's
            unique attributes, people, and priorities, all while safeguarding
            sensitive information.
          </p>
          <ul className={Prodstyles.prodinfo__list}>
            <li className={Prodstyles.prodinfo__listitem}>
              Protect sensitive data with Balance AI guaranteed security
              measures.
            </li>
            <li className={Prodstyles.prodinfo__listitem}>
              Simplify management using a unified governance framework across
              your entire data ecosystem.
            </li>
            <li className={Prodstyles.prodinfo__listitem}>
              Gain AI tailored insights aligned with your business's priorities,
              people, and unique data characteristics.
            </li>
          </ul>
          <div className={Prodstyles.prodinfo__frontboard__leftbuttons}>
            <a
    ...
    "Data Storage": {
      left: (
        <>
          ...
          <p className={Prodstyles.prodinfo__p}>
            Our platform efficiently hosts large volumes of company data at a
            highly competitive price, securely storing historical data and
            ensuring easy, quick access whenever needed. Enjoy cost-effective
            data management with seamless retrieval and scalability.
          </p>
          <ul className={Prodstyles.prodinfo__list}>
            <li className={Prodstyles.prodinfo__listitem}>
              Cost-effective data hosting for large volumes of company data.
            </li>
            <li className={Prodstyles.prodinfo__listitem}>
              Historical data is securely stored and easily accessible whenever
              needed.
            </li>
            <li className={Prodstyles.prodinfo__listitem}>
              Retrieve stored data quickly, ensuring seamless access for
